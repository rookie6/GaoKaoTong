# Generated by Django 2.0.10 on 2019-05-03 14:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proscore', models.CharField(blank=True, max_length=30, verbose_name='分数')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_type', models.CharField(blank=True, max_length=30, verbose_name='办学类型')),
                ('type_name', models.CharField(blank=True, max_length=30, verbose_name='院校类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sp_name', models.CharField(blank=True, max_length=30, verbose_name='专业名称')),
                ('level1_name', models.CharField(blank=True, max_length=30, verbose_name='专业层次')),
                ('level2_name', models.CharField(blank=True, max_length=30, verbose_name='专业门类')),
                ('level3_name', models.CharField(blank=True, max_length=30, verbose_name='专业类别')),
                ('limit_year', models.CharField(blank=True, max_length=30, verbose_name='专业学习年份')),
                ('degree', models.CharField(blank=True, max_length=30, verbose_name='授予学士')),
                ...
                ('rate', models.CharField(blank=True, max_length=30, verbose_name='男女比例')),
                ('sel_adv', models.CharField(blank=True, max_length=30, verbose_name='生源选择')),
            ],
            options={
                'verbose_name': '专业信息',
